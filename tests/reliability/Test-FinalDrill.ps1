...
# Phase 02 R5: candidate/commit require a non-empty generation identity.
Register-DshRestartCandidate -AttemptId 'drill-d6' -ProcessId 4242 -Generation 'drill-gen' | Out-Null
$env:DSH_RESTART_STABLE_WINDOW_SEC = '0'   # stable elapsed immediately (drill)
Confirm-DshRestartStable -AttemptId 'drill-d6' -ProcessId 4242 -Generation 'drill-gen' | Out-Null
